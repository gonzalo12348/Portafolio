...
export default function Skills () {
    return (
        <div className={styles.cont_main}>
            <section id='section-skills' className={styles.section_skills}>
                ...
                <div id="carouselExampleIntervalSkills" className={`${styles.carousel_cont} carousel slide`} data-bs-ride="carousel">
                <div className={`carousel-inner ${styles.carouselItem_cont}`}>
                    <div className={`${styles.cont_itemCarousel} carousel-item active`} data-bs-interval="100000">
                        <div className={styles.cont_skillsImg}>
                    ...
                    <div className={`${styles.cont_itemCarousel} carousel-item`}>
                        <div className={styles.cont_skillsImg}>
                            <div className={styles.cont_item}>
                                <img className={styles.skills_img} src="https://img.icons8.com/ultraviolet/240/000000/react--v1.png"/>
                                <h3 className={styles.title_skill}>ReactNative</h3>
                            </div>
                            <div className={styles.cont_item}>
                                <img className={styles.skills_img} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWv5j7g5me_UqiL3QeD8ISF5H9U8rEEfBnBQ&usqp=CAU"/>
                                <h3 className={styles.title_skill}>SQL</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleIntervalSkills" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleIntervalSkills" data-bs-slide="next">
